 ...
 * every route. However, Problem 67, is the same challenge with a triangle containing one-hundred 
 * rows; it cannot be solved by brute force, and requires a clever method! ;o)
 * 
 * ANSWER: 1074
 */

public class Problem18HighestTrianglePath {
	public static void main(String[] args) {
		...
		//Iterates over the last row to largest path
		int longestPath = 0;
